...
public class ComponentCInitMethodVisitor extends AdviceAdapter implements Opcodes {
     ...
     */
    protected ComponentCInitMethodVisitor(int api, MethodVisitor methodVisitor, int access, String name, String descriptor) {
